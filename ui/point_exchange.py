...
# Form implementation generated from reading ui file 'point_exchange.ui'
#
...
class Ui_Dialog(object):
    ...
    def setupUi(self, Dialog):
        ...
        self.exchange = QtWidgets.QLabel(self.layoutWidget)
        self.exchange.setObjectName("exchange")
        self.horizontalLayout_2.addWidget(self.exchange)
        ...
        self.point_exchange_ok_btn = QtWidgets.QPushButton(self.layoutWidget)
        self.point_exchange_ok_btn.setObjectName("point_exchange_ok_btn")
        self.horizontalLayout_2.addWidget(self.point_exchange_ok_btn)
        ...
        self.point_exchange_ok_btn.clicked.connect(self.point_exchange_ok_btn_clicked_connect)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "포인트 환전"))
        self.before.setText(_translate("Dialog", "현재 포인트"))
        self.after.setText(_translate("Dialog", "환전 후 포인트"))
        self.exchange.setText(_translate("Dialog", "환전할 포인트"))
        self.point_exchange_ok_btn.setText(_translate("Dialog", "확인"))
